...
def process_excel(uploaded_file):
    ...
    if CREATE_MAP:
        ...
        for c in get_valid_course_list(df_original):
            ...
            print("원본지도 반환값:", original_map_path)

            if original_map_path:
                print("원본 exists:", os.path.exists(original_map_path))
            ...
            print("최적화지도 반환값:", optimized_map_path)

            if optimized_map_path:
                print("최적화 exists:", os.path.exists(optimized_map_path))
